...
class ActivitypubApi(object):
    ...
    def activitypub_person(self, username, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.activitypub_person_with_http_info(username, **kwargs)  # noqa: E501
            return data
    ...
    def activitypub_person_with_http_info(self, username, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('username' not in params or
            ...
            raise ValueError("Missing the required parameter `username` when calling `activitypub_person`")  # noqa: E501
    ...
    def activitypub_person_inbox(self, username, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.activitypub_person_inbox_with_http_info(username, **kwargs)  # noqa: E501
        else:
            (data) = self.activitypub_person_inbox_with_http_info(username, **kwargs)  # noqa: E501
            return data
    ...
    def activitypub_person_inbox_with_http_info(self, username, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('username' not in params or
                                                       params['username'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `username` when calling `activitypub_person_inbox`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/activitypub/user/{username}/inbox', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
