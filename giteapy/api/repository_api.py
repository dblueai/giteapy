...
class RepositoryApi(object):
    ...
    def repo_download_pull_diff(self, owner, repo, index, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.repo_download_pull_diff_with_http_info(owner, repo, index, **kwargs)  # noqa: E501
        else:
            (data) = self.repo_download_pull_diff_with_http_info(owner, repo, index, **kwargs)  # noqa: E501
            return data

    def repo_download_pull_diff_with_http_info(self, owner, repo, index, **kwargs):  # noqa: E501
        """Get a pull request diff  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_download_pull_diff_with_http_info(owner, repo, index, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method repo_download_pull_diff" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'owner' is set
        if self.api_client.client_side_validation and ('owner' not in params or
                                                       params['owner'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `owner` when calling `repo_download_pull_diff`")  # noqa: E501
        # verify the required parameter 'repo' is set
        if self.api_client.client_side_validation and ('repo' not in params or
                                                       params['repo'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `repo` when calling `repo_download_pull_diff`")  # noqa: E501
        # verify the required parameter 'index' is set
        if self.api_client.client_side_validation and ('index' not in params or
                                                       params['index'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `index` when calling `repo_download_pull_diff`")  # noqa: E501
    ...
    def repo_download_pull_patch(self, owner, repo, index, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.repo_download_pull_patch_with_http_info(owner, repo, index, **kwargs)  # noqa: E501
        else:
            (data) = self.repo_download_pull_patch_with_http_info(owner, repo, index, **kwargs)  # noqa: E501
            return data

    def repo_download_pull_patch_with_http_info(self, owner, repo, index, **kwargs):  # noqa: E501
        """Get a pull request patch file  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_download_pull_patch_with_http_info(owner, repo, index, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method repo_download_pull_patch" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'owner' is set
        if self.api_client.client_side_validation and ('owner' not in params or
                                                       params['owner'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `owner` when calling `repo_download_pull_patch`")  # noqa: E501
        # verify the required parameter 'repo' is set
        if self.api_client.client_side_validation and ('repo' not in params or
                                                       params['repo'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `repo` when calling `repo_download_pull_patch`")  # noqa: E501
        # verify the required parameter 'index' is set
        if self.api_client.client_side_validation and ('index' not in params or
                                                       params['index'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `index` when calling `repo_download_pull_patch`")  # noqa: E501
