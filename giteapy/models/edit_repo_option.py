...
class EditRepoOption(object):
    ...
    def allow_rebase_update(self):
        ...
        either `true` to allow updating pull request branch by rebase, or `false` to prevent it. `has_pull_requests` must be `true`.  # noqa: E501
