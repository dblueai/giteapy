...
class GeneralRepoSettings(object):
    ...
    def __init__(self, http_git_disabled=None, lfs_disabled=None, migrations_disabled=None, mirrors_disabled=None, time_tracking_disabled=None, _configuration=None):  # noqa: E501
